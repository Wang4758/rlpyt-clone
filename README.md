# Note for master-thesis
Clone this repository into a folder named **rlpyt**. Clone it inside a project folder because next to this repository you will need other repos as well. The [THESIS-README](rlpyt/projects/safe/README.md) in the project folder describes all files and shows installation steps
```bash
$ mkdir mth && cd mth
$ git clone git@gitlab.lrz.de:ga84moc/rlpyt-clone.git rlpyt
# => proceed with rlpyt/projects/safe/README.md
```
