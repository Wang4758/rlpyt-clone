...
def logger_context(
    ...
    # exp_dir include the run_i to for the variant base dir remove that again...
    variant_base_dir = osp.abspath(osp.join(exp_dir, os.pardir))
    logger.set_variant_base_dir(variant_base_dir)
